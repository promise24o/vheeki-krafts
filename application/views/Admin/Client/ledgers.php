	...
	<div class="container-fluid">
						...
						<div class="card p-3 mb-4">
							<div class="row">
								<div class="col-md-4">
									...
									<table class="table">
										<tbody>
											<tr>
												<td width="40%">
													<img class="img-thumbnail" style="height: 140px; min-width: 140px; border-radius: 5px;" src="<?= $this->crud_model->get_image_url('clients', $client_details->id) ?>" alt="No img">
												</td>
												<td width="60%">
													<p><strong>Client:</strong> <?= $client_details->name ?></p>
													<p><strong>E-mail:</strong> <?= $client_details->email ?></p>
													<p><strong>Phone:</strong> <?= $client_details->phone ?></p>
													<p><strong>Address:</strong> <?= $client_details->address ?></p>
													<p><strong>Note:</strong> <?= $client_details->description ?? 'No notes available' ?></p>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<div class="col-md-4 text-center">
									...
									<div>
										<p><strong>Total Receivable Amount</strong></p>
										<h3><?= number_format($total_receivable_amount, 2) ?></h3>
									</div>
								</div>
								<div class="col-md-4 text-center">
									<div>
									...
									<div>
										<p><strong>Total Received Amount</strong></p>
										<h3><?= number_format($total_received_amount, 2) ?></h3>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="card">
			<div class="card-header">
				<i class="fi fi-rr-list"></i>List of Client Ledger Entries
			</div>
			<div class="card-body">
				<div class="card-header">
