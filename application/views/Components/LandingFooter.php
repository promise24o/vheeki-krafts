	...
	<div class="container container-xxl pt-4">
		<div class="row">
			<div class="col-lg-5 col-12 mb-11 mb-lg-0">
				<h3 class="mb-6">Discover Artistic</h3>
				<p class="pe-xl-24 mb-lg-11">Explore our unique drawings and paintings crafted with passion to inspire your space.</p>
				<a class="fw-semibold fs-6 text-decoration-none" href="<?= base_url('shop') ?>">
					Visit Our Store<svg class="icon ms-5">
			...
			<div class="col-lg col-md-4 col-12 mb-11 mb-lg-0">
				...
				<ul class="list-unstyled mb-0 fw-medium">
					<li class="pt-3 mb-4">
						<a href="<?= base_url('about') ?>" title="About us" class="text-body">About us</a>
					</li>
					<li class="pt-3 mb-4">
						<a href="<?= base_url('shop') ?>" title="Store Locations" class="text-body">Our Store</a>
					</li>
					<li class="pt-3 mb-4">
						<a href="<?= base_url('reviews') ?>" title="Reviews" class="text-body">Reviews</a>
					</li>
				</ul>
			</div>
			<div class="col-lg col-md-4 col-12 mb-11 mb-lg-0">
				...
				<ul class="list-unstyled mb-0 fw-medium">
					<li class="pt-3 mb-4">
						<a href="<?= base_url('shop?highlight=new_arrival') ?>" title="New Products" class="text-body">New Products</a>
					</li>
					<li class="pt-3 mb-4">
						<a href="<?= base_url('shop?highlight=best_seller') ?>" title="Best Sellers" class="text-body">Best Sellers</a>
					</li>
					<li class="pt-3 mb-4">
						<a href="<?= base_url('track-order') ?>" title="Track Order" class="text-body">Track Order</a>
					</li>
				</ul>
			</div>
			<div class="col-lg col-md-4 col-12 mb-11 mb-lg-0">
				...
				<ul class="list-unstyled mb-0 fw-medium">
					<li class="pt-3 mb-4">
						<a href="<?= base_url('delivery') ?>" title="Delivery" class="text-body">Delivery</a>
					</li>
					<li class="pt-3 mb-4">
						<a href="<?= base_url('privacy') ?>" title="Privacy Policy" class="text-body">Privacy Policy</a>
					</li>
					<li class="pt-3 mb-4">
						<a href="<?= base_url('contact') ?>" title="Contact Us" class="text-body">Contact Us</a>
					</li>
				</ul>
			</div>
		</div>
		<div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
			<div class="col-sm-12 col-md-6 col-lg-4 d-flex align-items-center order-2 order-lg-1 fs-6 mt-11 mt-lg-0">
				<p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Vheeki Krafts | Built with <svg width="16" height="16" viewBox="0 0 24 24" fill="red" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="col-sm-12 col-lg-4 text-md-center order-1 order-lg-2 ">
				<a class="d-inline-block" href="./">
					...
					<img class="lazy-image img-fluid light-mode-img" src="#"
						data-src="<?= base_url() ?>assets/landing/images/others/logo.png" width="179" height="26"
						alt="Vheeki Krafts">
					<img class="lazy-image dark-mode-img img-fluid" src="#"
						data-src="<?= base_url() ?>assets/landing/images/others/logo-white.png" width="179"
						height="26" alt="Vheeki Krafts">
				</a>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-4 order-3 text-sm-start text-lg-end mt-11 mt-lg-0">
				<img src="#" data-src="<?= base_url() ?>assets/landing/images/others/paystack.webp" width="313"
...
<script src="<?= base_url() ?>assets/landing/vendors/bootstrap/js/bootstrap.bundle.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/clipboard/clipboard.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/vanilla-lazyload/lazyload.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/waypoints/jquery.waypoints.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/lightgallery/lightgallery.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/lightgallery/plugins/zoom/lg-zoom.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/lightgallery/plugins/video/lg-video.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js">
</script>
<script src="<?= base_url() ?>assets/landing/vendors/isotope/isotope.pkgd.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/slick/slick.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/gsap/gsap.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/gsap/ScrollToPlugin.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/gsap/ScrollTrigger.min.js"></script>
<script src="<?= base_url() ?>assets/landing/vendors/mapbox-gl/mapbox-gl.js"></script>
<script src="<?= base_url() ?>assets/landing/js/theme.min.js"></script>
<!-- Toastr JS -->
...
document.addEventListener('click', function(e) {
	if (e.target.closest('.remove-cart-item')) {
		e.preventDefault();
		const cartId = e.target.closest('.remove-cart-item').dataset.cartId;
...
document.addEventListener('click', function(e) {
	if (e.target.closest('.cart-qty-decrease')) {
		e.preventDefault();
		const cartId = e.target.closest('.cart-qty-decrease').dataset.cartId;
...
document.addEventListener('click', function(e) {
	if (e.target.closest('.cart-qty-increase')) {
		e.preventDefault();
		const cartId = e.target.closest('.cart-qty-increase').dataset.cartId;
		const row = document.querySelector(`tr[data-cart-id="${cartId}"]`);
		const input = row.querySelector('.cart-qty-input');
		let quantity = parseInt(input.value);
		...
		<nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
			<div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
				<a href="./" class="navbar-brand py-4 d-lg-inline-block">
					<img src="<?= base_url() ?>assets/landing/images/others/logo.png" height="26"
						alt="Vheeki Krafts">
				</a>
			</div>
...
<div id="shoppingCart" data-bs-scroll="false" class="offcanvas offcanvas-end">
	<div class="offcanvas-header fs-4">
		<h4 class="offcanvas-title fw-semibold">Shopping Bag (<span id="sideCartCount">0</span>)</h4>
			...
			<?php else: ?>
				<table class="table table-borderless">
					<tbody>
						...
						<tr class="position-relative cart-item-row" data-cart-id="<?= $item['cart_id'] ?>">
							<td class="align-middle text-center">
								<a href="javascript:void(0)" class="d-block clear-product remove-cart-item" data-cart-id="<?= $item['cart_id'] ?>">
									<i class="far fa-times"></i>
								</a>
							</td>
								...
								<div class="d-flex align-items-center">
									<div class="me-6">
										<img src="<?= $item['image'] ?: base_url('assets/admin/images/placeholder.png') ?>"
											width="60" height="80" alt="<?= htmlspecialchars($item['product_name']) ?>"
											style="object-fit: cover;">
									</div>
									<div class="">
										<p class="card-text mb-1">
											<?php if ($item['discount_price']): ?>
												<span class="fs-13px fw-500 text-decoration-line-through pe-3">₦<?= number_format($item['price'], 2) ?></span>
												<span class="fs-15px fw-bold text-body-emphasis">₦<?= number_format($item['discount_price'], 2) ?></span>
											<?php else: ?>
												<span class="fs-15px fw-bold text-body-emphasis">₦<?= number_format($item['price'], 2) ?></span>
											<?php endif; ?>
										</p>
										<p class="fw-500 text-body-emphasis mb-0"><?= htmlspecialchars($item['product_name']) ?></p>
							...
							<td class="align-middle p-0">
								<div class="input-group position-relative shop-quantity">
									<a href="javascript:void(0)" class="shop-down position-absolute z-index-2 cart-qty-decrease" data-cart-id="<?= $item['cart_id'] ?>">
										<i class="far fa-minus"></i>
									</a>
									<input type="number"
										class="form-control form-control-sm px-6 py-4 fs-6 text-center border-0 cart-qty-input"
										value="<?= $item['quantity'] ?>"
										min="1"
										max="<?= $item['stock_quantity'] ?>"
										readonly>
									<a href="javascript:void(0)" class="shop-up position-absolute z-index-2 cart-qty-increase" data-cart-id="<?= $item['cart_id'] ?>">
					...
					<div class="col-md-6 pe-13">
						<div class="position-relative">
							...
							<div id="slider"
								...
								<a href="<?= base_url() ?>assets/landing/images/shop/product-gallery-05.jpg"
									data-gallery="gallery1"
									data-thumb-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-05.jpg"><img
										src="#"
										data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-05.jpg"
										class="h-auto lazy-image" width="540" height="720" alt=""></a>
								<a href="<?= base_url() ?>assets/landing/images/shop/product-gallery-06.jpg"
									data-gallery="gallery1"
									data-thumb-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-06.jpg"><img
										src="#"
										data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-06.jpg"
										class="h-auto lazy-image" width="540" height="720" alt=""></a>
								<a href="<?= base_url() ?>assets/landing/images/shop/product-gallery-07.jpg"
									data-gallery="gallery1"
									data-thumb-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-07.jpg"><img
										src="#"
										data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-07.jpg"
										class="h-auto lazy-image" width="540" height="720" alt=""></a>
								<a href="<?= base_url() ?>assets/landing/images/shop/product-gallery-08.jpg"
									data-gallery="gallery1"
									data-thumb-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-08.jpg"><img
										src="#"
										data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-08.jpg"
										class="h-auto lazy-image" width="540" height="720" alt=""></a>
							</div>
						</div>
						<div class="mt-6">
							<div id="slider-thumb" class="slick-slider slick-slider-thumb ps-1 ms-n3 me-n4"
								...
								<img src="#"
									data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-05-154x205.jpg"
									class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100"
									alt="">
								<img src="#"
									data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-06-154x205.jpg"
									class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100"
									alt="">
								<img src="#"
									data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-07-154x205.jpg"
									class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100"
									alt="">
								<img src="#"
									data-src="<?= base_url() ?>assets/landing/images/shop/product-gallery-08-154x205.jpg"
									class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100"
									alt="">
							</div>
						</div>
					...
					<div class="col-md-6 pt-md-0 pt-10">
						...
						<p class="mb-4 pb-2">
							<span class="text-body-emphasis">
								...
								17 people
							</span> are viewing this right now
						</p>
						...
						<div class="card border-0 bg-body-tertiary rounded text-center mt-7">
							<div class="pt-8 px-5">
								<img class="img-fluid"
									src="<?= base_url() ?>assets/landing/images/shop/product-info-2.png" alt="pay"
									width="357" height="28">
							</div>
            ...
            <ul class="navbar-nav w-100">
                ...
                <li class="nav-item py-2 px-3 dropdown">
                    ...
                    <ul class="dropdown-menu border-0 shadow-sm mt-1">
                        <li>
                            <a class="dropdown-item py-3 border-hover" href="<?= base_url('about') ?>">
                                <span class="border-hover-target">About Us</span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item py-3 border-hover" href="<?= base_url('contact') ?>">
